...
Item
{
    ...
    ButtonElement
    {
        ...
        onButtonRightPress:
        {
            appData.data= EnumClass.GUI_BUTTON_OK_ASSIGN_STATIC_DEVICE_IP +
                    String.fromCharCode(uiMsgFsp).toString() +
                    ipAddress.getIpFieldValue() +
                    String.fromCharCode(uiMsgFsp).toString() +
                    String.fromCharCode(eotFsp).toString()
        }
    }
    ...
    Item
    {
        ...
        Rectangle
        {
            ...
            {
                id 					: submitBtn
                text 				: (dispStr.readDispStr(DispStr.MSG_SKIP_TO_DYNAMIC_930)) //"Skip to Dynamic"
                color				: "#d8d8d8"
                font.pointSize  	: 14
            ...
            MouseArea
            {
                ...
                onPressed:
                {
                    appData.data = EnumClass.GUI_BUTTON_SKIP_DYNAMIC_IP_PROCESS +
                            String.fromCharCode(uiMsgFsp).toString() +
                            String.fromCharCode(eotFsp).toString()
                }
            }
    ...
    MxRectangleFrame
    {
        ...
        MxText
        {
            ...
            anchors.topMargin   : 8
            anchors.horizontalCenter: parent.horizontalCenter
            text                : dispStr.readDispStr(DispStr.MSG_ENTER_DEVICE_IP_ADDRESS_929) /*"Enter Device Ip Address"*/
            color               : "#d8d8d8"
            font.pointSize      : 12
        }
        MxText
