...
static struct vop2_vp_data rk3568_vp_data[3] = {
	{
		...
		.pre_scan_max_dly = 42,
/* matrix patch
fix the display resolution to 720p , reason is uboot could not display image with 4K resoultion. Second reason is uboot could not display image in full screen.
*/ 		
                .max_output = {1280, 720}/*{4096, 2304}*/,
	},
	{
		.feature = 0,
		.pre_scan_max_dly = 40,
