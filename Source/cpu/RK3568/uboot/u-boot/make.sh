...
LOCAL_SDK_PATH=${SVN_HOME_DIR}/Briefcase/SWD_Briefcase/Security/RDK/Rockchip/RK3568/rk356x_linux_release_v1.3.0_20220122/rk356x_nvr_lite_1.3.0_20220122
RKBIN_TOOLS=${LOCAL_SDK_PATH}/rkbin/tools
CROSS_COMPILE_ARM32=${LOCAL_SDK_PATH}/build/toolchain/bin/aarch64-linux-
CROSS_COMPILE_ARM64=${LOCAL_SDK_PATH}/build/toolchain/bin/aarch64-linux-
########################################### User not touch #############################################
